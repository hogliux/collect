...
import com.renngiles.beesweet.collect.android.exception.GDriveConnectionException;
import com.renngiles.beesweet.collect.android.exception.JavaRosaException;
import com.renngiles.beesweet.collect.android.listeners.AdvanceToNextListener;
import com.renngiles.beesweet.collect.android.listeners.FormLoaderListener;
import com.renngiles.beesweet.collect.android.listeners.FormSavedListener;
import com.renngiles.beesweet.collect.android.listeners.SavePointListener;
import com.renngiles.beesweet.collect.android.logic.FormController;
import com.renngiles.beesweet.collect.android.logic.FormController.FailedConstraint;
...
import com.renngiles.beesweet.collect.android.provider.FormsProviderAPI.FormsColumns;
...
import com.renngiles.beesweet.collect.android.tasks.FormLoaderTask;
import com.renngiles.beesweet.collect.android.tasks.SavePointTask;
import com.renngiles.beesweet.collect.android.tasks.SaveResult;
import com.renngiles.beesweet.collect.android.tasks.SaveToDiskTask;
...
import com.renngiles.beesweet.collect.android.utilities.FileUtils;
import com.renngiles.beesweet.collect.android.utilities.MediaUtils;
import com.renngiles.beesweet.collect.android.views.ODKView;
...
public class FormEntryActivity extends Activity implements AnimationListener,
                ...
                if (getContentResolver().getType(uri).equals(InstanceColumns.CONTENT_ITEM_TYPE)) {
                    ...
                    try {
                        ...
                        if (c.getCount() != 1) {
                            ...
                            File cacheDir = new File(Collect.getODKPath (Collect.CACHE_PATH_ID));
                            ...
                            for (int i = 0; i < files.length; ++i) {
                                ...
                                File instanceDir = new File(
                                        Collect.getODKPath (Collect.INSTANCES_PATH_ID) + File.separator
                                                + instanceDirName);
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        switch (requestCode) {
             ...
             */
                ...
                // file
                File fi = new File(Collect.getODKPath (Collect.TMPFILE_PATH_ID));
    ...
    public void loadingComplete(FormLoaderTask task) {
        ...
        if (formController.getInstancePath() == null) {
            ...
            String file = mFormPath.substring(mFormPath.lastIndexOf('/') + 1,
                    mFormPath.lastIndexOf('.'));
            String path = Collect.getODKPath (Collect.INSTANCES_PATH_ID) + File.separator + file + "_"
                    + time;
    ...
    private void sendSavedBroadcast() {
        Intent i = new Intent();
        i.setAction("com.renngiles.beesweet.collect.android.FormSaved");
