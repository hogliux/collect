...
public final class FormsProviderAPI {
    public static final String AUTHORITY = "com.renngiles.beesweet.collect.android.provider.odk.forms";
    ...
    public static final class FormsColumns implements BaseColumns {
        ...
        public static final String INTERN_FORM_ID = "internFormId";
        public static final String INTERN_IS_HIDDEN = "isHidden";
