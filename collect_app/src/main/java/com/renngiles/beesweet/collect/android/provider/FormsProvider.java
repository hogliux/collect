...
package com.renngiles.beesweet.collect.android.provider;
...
import com.renngiles.beesweet.collect.android.database.ODKSQLiteOpenHelper;
...
public class FormsProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends ODKSQLiteOpenHelper {
        ...
        DatabaseHelper(String databaseName) {
            super(Collect.getODKPath (Collect.METADATA_PATH_ID), databaseName, null, DATABASE_VERSION);
        }
    ...
    public synchronized Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (values.containsKey(FormsColumns.JRCACHE_FILE_PATH) == false) {
            String cachePath = Collect.getODKPath (Collect.CACHE_PATH_ID) + File.separator + md5
                    + ".formdef";
                    ...
                    if (update.getCount() > 0) {
                        ...
                        if (values.containsKey(FormsColumns.FORM_FILE_PATH)) {
                            ...
                            values.put(FormsColumns.JRCACHE_FILE_PATH,
                                    Collect.getODKPath (Collect.CACHE_PATH_ID) + File.separator + newMd5
                                            + ".formdef");
                        }
